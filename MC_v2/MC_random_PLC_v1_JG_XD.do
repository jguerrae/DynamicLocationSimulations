...
*** 3. ALLOCATE TO EACH OF THE 971,000 FIRMS PSEUDO-RANDONLY A LOCATION WITHIN THE SET OF 1,925 POSSIBLE COUNTIES, FOLLOWING THE 1890 CROSS COUNTY SHARE OF MANUFACTURING ESTABLISHMENTS, INCOME MARKETS ACCESS, INCOME FOREIGN MARKET ACCESS, KNOWLEDGE STOCK AND AUTO KNOWLEDGE STOCK 3 OR THE 1890 COUNTY SHARE OF AUTO SPECIALIZATION OR AUTO DIVERSITY  
*** 4B. ALLOCATE TO EACH OF THE 971,000 FIRMS PSEUDO-RANDOMLY A SURVIVAL AGE, WITH SURVIVAL ONE MORE YEAR=1 IF RANDOM SHOCK IS LOWER THAN ESTIMATED PROBABILITY OF SURVIVAL ONE MORE YEAR, GIVEN ASSEMBLER AGE
***
...
set obs 971000
set seed 1883
gen cfipsid = floor((999+1)*runiform() + 1)


IS IT POSSIBLE TO DO LOOP TO  gen cfipsCROSSCOUNTYVARNAME = floor ((999+1)*rununiform() +1 ) + CONVERT INPUT FILE INTO 1,000S INSTEAD OF 100% SHARES 
