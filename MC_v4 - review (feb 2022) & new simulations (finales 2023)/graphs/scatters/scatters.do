...
cd "D:\CLOUD\Universidad de los Andes\Xavier Hernando Duran Amorocho - Jorge Guerra\MCs\MC_v4\graphs\scatters"

foreach k of numlis  1 2 3 {
	
	clear all

	use "D:\CLOUD\Universidad de los Andes\Xavier Hernando Duran Amorocho - Jorge Guerra\MCs\MC_v4\graphs\\`k'" //Los que están acá ubicados son dinámicos

	merge 1:1 cfips year using "D:\CLOUD\Universidad de los Andes\Xavier Hernando Duran Amorocho - Jorge Guerra\MCs\MC_v4\graphs\lq_original"
	drop _merge
