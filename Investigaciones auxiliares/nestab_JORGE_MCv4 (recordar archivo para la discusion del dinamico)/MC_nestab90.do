...
cd "D:\CLOUD\Universidad de los Andes\Xavier Hernando Duran Amorocho - Jorge Guerra\MCs\MC_v4\nestab"
...
drop _merge
drop in 971000/971006


gen MC_nestab90_ = - MC_nestab90
sort year MC_nestab90_ cfips_firms
bysort year: gen nobs = _n


merge 1:1 year nobs  using "MC_inputdata_cfips_nestab90_971000"
keep if repid!=.
drop cfips_firms
