...
cd "D:\CLOUD\Universidad de los Andes\Xavier Hernando Duran Amorocho - Jorge Guerra\MCs\MC_v3\mktaccess1890\"
...
set obs 971000
set seed 3219
gen cfipsfirmsid = floor(( 99999 +1)*runiform() + 1)
...
sort cfipsfirmsid
merge m:m cfipsfirmsid using "MC_inputdata_cfips_bi_mktaccess1890.dta"
drop _merge
...
foreach x of numlist 1900 1910 1920 1930{
	...
	if year==`x', title(Kernel mktaccess `x' ) graphregion(color(white)) xscale(range(0 5))
...
twoway  (kdensity copB2_3 if year ==1900, lcolor(black)) ///
 ...
 title(TS Kernel mkt ) graphregion(color(white)) xscale(range(0 5)) ///
...
foreach x of numlist 36061 25025 42101 17031 39061 39035 26163 18141 17019 {
	...
	title(mktaccess_survivalB2 & observed: `x') graphregion(color(white))
