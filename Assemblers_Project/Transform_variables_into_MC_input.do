...
*** SCATTERPLOTS TO DESCRIBE NESTAB, MARKET ACCESS AND KNOWLEDGE STOCK

scatter share_bi_mktaccess1890 share_ks_tot share_nestab90 if share_nestab90<0.02 , sort mlabel(clabel clabel)
